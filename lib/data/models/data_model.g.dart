...
_$_DataModel _$$_DataModelFromJson(Map<String, dynamic> json) {
  $checkKeys(
    json,
    requiredKeys: const ['owner', 'license'],
  );
  return _$_DataModel(
    id: json['id'] as int? ?? 0,
...
_$_LicenseBean _$$_LicenseBeanFromJson(Map<String, dynamic> json) =>
    _$_LicenseBean(
...
Map<String, dynamic> _$$_LicenseBeanToJson(_$_LicenseBean instance) =>
    <String, dynamic>{
      'key': instance.key,
      'name': instance.name,
...
_$_OwnerBean _$$_OwnerBeanFromJson(Map<String, dynamic> json) => _$_OwnerBean(
...
Map<String, dynamic> _$$_OwnerBeanToJson(_$_OwnerBean instance) =>
    <String, dynamic>{
